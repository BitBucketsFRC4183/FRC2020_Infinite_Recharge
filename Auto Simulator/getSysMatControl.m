function A = getSysMatControl(state)
    ...
    %
    A(R, V) = cos(state(THETA) - state(THETA_R));
    A(R, THETA) = state(V) * cos(state(THETA) - state(THETA_R));
    A(R, THETA_R) = -state(V) * cos(state(THETA) - state(THETA_R));
    ...
    A(THETA_R, R) = -state(V)/state(R)^2 * sin(state(THETA) - state(THETA_R));
    A(THETA_R, THETA) = state(V)/state(R) * cos(state(THETA) - state(THETA_R));
    A(THETA_R, THETA_R) = -state(V)/state(R) * cos(state(THETA) - state(THETA_R));
