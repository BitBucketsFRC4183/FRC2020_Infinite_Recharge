 ...
 */
public class RamseteSpecial extends RamseteController{
  ...
  public RamseteSpecial(double b, double zeta) {
    m_b = b;
    m_zeta = zeta;
  }
  ...
  public ChassisSpeeds calculate(Pose2d currentPose,
    ...
    double k = 2.0 * m_zeta * Math.sqrt(Math.pow(omegaRef, 2) + m_b * Math.pow(vRef, 2) + 10);
