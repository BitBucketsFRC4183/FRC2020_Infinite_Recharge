...
public class TrenchFiveBall {
     ...
     */
    public TrenchFiveBall(TrajectoryConfig config) {

        Translation2d startingPoint = FieldConstants.START_OUR_TRENCH;
    ...
    public FullTrajectory getFullTrajectory() {
        return new FullTrajectory("our trench", firstPickup, firstReturn, secondPickup, secondPickup);
    }
